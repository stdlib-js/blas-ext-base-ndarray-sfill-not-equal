...
> Replace elements in a one-dimensional single-precision floating-point ndarray not equal to a provided search element with a specified scalar constant.
...
```javascript
import sfillNotEqual from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ndarray-sfill-not-equal@esm/index.mjs';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-ndarray-sfill-not-equal.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-ndarray-sfill-not-equal

[test-image]: https://github.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-ndarray-sfill-not-equal?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-ndarray-sfill-not-equal.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-ndarray-sfill-not-equal/main/LICENSE

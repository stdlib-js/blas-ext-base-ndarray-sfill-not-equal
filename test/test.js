...
tape( 'the function replaces elements not equal to a provided search element', function test( t ) {
	...
	actual = sfillNotEqual( [ x, searchElement, alpha, start, end ] );
	t.strictEqual( actual, x, 'returns expected value' );

	expected = new Float32Array( [ 0.0, 5.0, 5.0, 0.0, 5.0, 5.0 ] );
...
tape( 'the function supports an input ndarray having a non-unit stride', function test( t ) {
	...
	expected = new Float32Array( [ 0.0, -2.0, 5.0, 0.0, 5.0, -6.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'the function supports an input ndarray having a non-zero offset', function test( t ) {
	...
	expected = new Float32Array( [ 0.0, -2.0, 3.0, 0.0, 5.0, 5.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'the function supports a nonnegative starting index', function test( t ) {
	...
	expected = new Float32Array( [ 0.0, -2.0, 5.0, 0.0, 5.0, 5.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'the function supports a nonnegative ending index', function test( t ) {
	...
	expected = new Float32Array( [ 0.0, 5.0, 5.0, 0.0, 4.0, -6.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'if a resolved starting index is greater than or equal to a resolved ending index, the function returns the input ndarray unchanged', function test( t ) {
	...
	xbuf = new Float32Array( [ 0.0, -2.0, 3.0, 0.0 ] );
	x = vector( xbuf, 4, 1, 0 );
	searchElement = scalar2ndarray( 0.0, {
		'dtype': 'float32'
	});
	...
	expected = new Float32Array( [ 0.0, -2.0, 3.0, 0.0 ] );
...
tape( 'the function supports specifying a fill range for an input ndarray having a non-unit stride', function test( t ) {
	...
	xbuf = new Float32Array( [ 0.0, -2.0, 3.0, 4.0 ] );
	x = vector( xbuf, 2, 2, 0 );
	searchElement = scalar2ndarray( 0.0, {
		'dtype': 'float32'
	});
